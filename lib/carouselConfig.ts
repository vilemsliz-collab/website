...
export const CARDS: CardData[] = [
  ...
  { id: '003', lines: ['Wrike AI —', 'I made it glow.'],               role: 'Interaction Designer',  href: '/cases/003', bg: '#0d1a0d', ac: '#4dd0e1', img: 'https://res.cloudinary.com/duee5dfom/image/upload/f_auto,q_auto/carousel-card-pictures/case-003-new' },
