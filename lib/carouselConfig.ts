...
export const CARDS: CardData[] = [
  { id: 'about', name: 'Vilém Slíž', lines: ['Brand experience', 'Expressive UI'], role: '', href: '/cases/about', bg: '#ffffff', ac: '#000000', isAbout: true, headline: "Feeling isn't accidental\nIt's designed.", img: 'https://res.cloudinary.com/duee5dfom/image/upload/q_auto/f_auto/v1778365303/7826c895-4091-4159-9025-999e4f274797.png' },
